...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*w.Training.Weight + (math.Pow(SpeedInMs, 2)/(w.Height/CmInM))*CaloriesSpeedHeightMultiplier*w.Training.Weight) * w.Training.Duration.Hours() * MinInHours)
}
